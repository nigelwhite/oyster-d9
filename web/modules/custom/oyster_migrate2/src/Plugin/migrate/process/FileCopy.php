...
namespace Drupal\oyster_migrate2\Plugin\migrate\process;
...
/**
* This is customised following https://drupal.stackexchange.com/questions/300563/do-i-need-write-access-to-the-files-directory-to-migrate-d7-file
* not enough detail there to get the code right 
* 
...
class FileCopy extends FileProcessBase implements ContainerFactoryPluginInterface {
  ...
  public function transform($value, MigrateExecutableInterface $migrate_executable, Row $row, $destination_property) {
    ...
    //   ->writeFile($source, $destination, $this->configuration['file_exists']);
